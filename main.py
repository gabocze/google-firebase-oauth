...
def root():
    ...
    if id_token:
        try:
            ...
            # http://flask.pocoo.org/docs/1.0/quickstart/#sessions). TODO add cache as per https://googleapis.dev/python/google-auth/latest/reference/google.oauth2.id_token.html
